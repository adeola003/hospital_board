...
**[Hospiatal board]** is about building a simple rails application that consists of a receptionist portal & doctor portal which performs the following tasks:
...
```sh
  git clone https://github.com/adeola003/hospital_board.git
  cd hospital_board
```
> Install Gemfile
...
Feel free to check the [issue page](https://github.com/adeola003/hospital_board/issues)
